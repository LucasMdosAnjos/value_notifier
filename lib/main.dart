...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        Provider(create: (BuildContext context)=>Uno(),),
        Provider(create: (BuildContext context)=>ProductService(context.read()),),
        ChangeNotifierProvider(create: (BuildContext context) =>ProductStore(context.read()),)
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
